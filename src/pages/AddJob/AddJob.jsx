...
const AddJob = () => {
    ...
    const handleAddJob = e => {
        ...
        fetch('https://job-portal-server-for-recruiter-part3-neon-omega.vercel.app/jobs', {
            method: 'POST',
            headers: {
        ...
        <div>
            ...
            <form onSubmit={handleAddJob} className="card-body">
                ...
                <div className="form-control">
                    ...
                    <input type="text" value={user?.email}  name='hr_email' placeholder="HR Email" className="input input-bordered" required />
                </div>
